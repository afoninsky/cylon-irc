...
var defaultConfig = {
  ...
  private: true,        // true - use robot name as private channel, string - private channel name
...
var Driver = module.exports = function Driver(_cfg) {
  ...
  this.extractTokens = function (text) {
    return this.lang.extractTokens(text, this.cfg.minTokenLength);
  };
};
...
Driver.prototype.sendNatural = function (channels, message) {
